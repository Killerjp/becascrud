                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            @foreach ($grupofs as $grupof)
                                ...
                                {{ __('Grupo Familiar Admin') }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Total de ingresos Grupo Familiar:</b>&nbsp;{{ number_format($suma , 0,3 ) }}
                            </span>
                             ...
                             <div class="float-right">
                                ...
                                <a href="{{ route('gf.create','$grupof->id_postulant') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Crear Nuevo') }}@csrf
                                </a>&nbsp;&nbsp;
